...
当权重全部设为1后,和清华结果一致,不过不知道为什么清华程序结果不稳定"""
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        logits0 = (logits_dict[0][0] * logits_gravity[0][0] + logits_dict[1][0] * logits_gravity[0][1] + logits_dict[2][0] * logits_gravity[0][2]\
                  ...
                  + logits_dict[6][0] * logits_gravity[0][6] + logits_dict[7][0] * logits_gravity[0][7]) / 8
        ...
        logits1 = (logits_dict[0][1] * logits_gravity[1][0] + logits_dict[1][1] * logits_gravity[1][1] + logits_dict[2][1] * logits_gravity[1][2]\
                  ...
                  + logits_dict[6][1] * logits_gravity[1][6] + logits_dict[7][1] * logits_gravity[1][7]) / 8
        ...
        for filenames, images in load_images(FLAGS.input_dir, batch_shape):
            ...
            for i in range(FLAGS.num_iter):
                ...
                for j in range(FLAGS.batch_size):
                    ...
                    #
                    # ens_Pred_Value = [end_points_v3_Pred, end_points_adv_v3_Pred, end_points_ens3_adv_v3_Pred,
            ...
            #     if int(true_label[j]) == Prediction[j]:      # The test tag is always 1 more than the real tag, so I subtract 1 here
            #         success_num += 1
